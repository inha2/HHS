            ...
            <div className="accordion-container">
                <Accordion className="accordion-section" allowZeroExpanded={true}>
                    <AccordionItem>
                        ...
                        <AccordionItemPanel className="table-all">
                            <table>
                                <tbody>
                                    <tr>
                                        <th>(cm)</th>
                            ...
                            <p className="table-content">제품컷의 색상이 실제 제품 색상과 가장 비슷합니다.</p>
                            <p className="table-content">
                                상세 사이즈는 제품의 특성 또는 측정 위치에 따라 약간의 오차가 있을 수 있습니다.
                            </p>
                        </AccordionItemPanel>
                    </AccordionItem>
                    <AccordionItem>
                        ...
                        <AccordionItemPanel>
                            <ul class="dePrdInfo">
                                <li>
                                    <span className="detail-name">품명 및 모델명</span>
                                    <span className="detail-content">아웃포켓 베이직 윈드브레이커</span>
                                </li>
                                <li>
                                    <span className="detail-name">소재</span>
                                    <span className="detail-content">겉감: 나일론 100% / 주머니감: 나일론 100%</span>
                                </li>
                                <li>
                                    <span className="detail-name">색상</span>
                                    <span className="detail-content">블랙 그레이 그레이시퍼플</span>
                                </li>
                                <li>
                                    <span className="detail-name">치수</span>
                                    <span className="detail-content">
                                        XS, S, M, L(상세 사이즈는 사이즈 가이드 참고)
                                    </span>
                                </li>
                                <li>
                                    <span className="detail-name">제조년월</span>
                                    <span className="detail-content">
                                        2023년 11월(지속적인 생산으로 인해 고객분들께 발송되는 상품별로 제조일자가
                                        상이할 수 있습니다.)
                                    </span>
                                </li>
                                <li>
                                    <span className="detail-name">제조국</span>
                                    <span className="detail-content">
                                        베트남(제조국은 1차 생산지 기준이며, 리오더가 이루어질 경우 다른 국가에서 생산될
                                        수 있습니다.)
                                    </span>
                                </li>
                                <li>
                                    <span className="detail-name">제조자/수입자</span>
                                    <span className="detail-content">(주)에이피알</span>
                                </li>
                                <li>
                                    <span className="detail-name">취급시 주의사항</span>
                                    <span className="detail-content">
                                        짙은 색상은 이염의 우려가 있으니 단독 세탁하여 주십시오. 세탁시 미지근한 물에서
                                        중성세제를 사용하십시오.
                                    </span>
                                </li>
                                <li>
                                    <span className="detail-name">품질보증기준</span>
                                    <span className="detail-content">관련법 및 소비자분쟁해결 기준에 따름</span>
                                </li>
                                <li>
                                    <span className="detail-name">AS책임자와 전화번호</span>
                                    <span className="detail-content">1544-2083 (주)에이피알 고객센터</span>
                                </li>
                            </ul>
                        </AccordionItemPanel>
                    </AccordionItem>
                    <AccordionItem>
                        ...
                        <AccordionItemPanel className="detail-washing-all">
                            <p className="detail-washing">뒤집어 찬물에 단독 손세탁 하십시오.</p>
                            <p className="detail-washing">표백하지 마십시오.</p>
                            <p className="detail-washing">옷걸이에 걸어서 그늘에서 건조시켜주십시오.</p>
                        </AccordionItemPanel>
                    </AccordionItem>
                    <AccordionItem>
                        <AccordionItemHeading>
                        ...
                        <AccordionItemPanel className="detail-payment-all">
                            <p className="detail-payment">
                                고액결제의 경우 안전을 위해 카드사에서 확인 전화를 드릴 수도 있습니다.
                                <br /> 확인 과정에서 도난 카드의 사용이나 타인 명의의 주문 등 정상적인 주문이 아니라고
                                판단될 경우 임의로 주문을 보류 또는 취소할 수 있습니다.
                                <br /> 가상계좌 주문의 경우, 3일 이내로 입금이 진행되어야 하며 입금되지 않은 주문은
                                자동취소 됩니다.
                            </p>
                        </AccordionItemPanel>
                    </AccordionItem>
                    <AccordionItem>
                        ...
                        <AccordionItemPanel className="detail-payment-all">
                            <p className="detail-delivery">- 배송방법 : 택배</p>
                            <p className="detail-delivery">- 배송 지역 : 전국지역</p>
                            <p className="detail-delivery">- 배송 비용 : 3,000원</p>
                            <p className="detail-delivery">- 배송 기간 : 3일 ~ 7일</p>
                            <p className="detail-delivery">
                                - 배송 안내 :제주도 및 도서산간 지역으로의 배송인 경우 [4,000원의 배송비가 추가됩니다.]
                            </p>
                            <p className="detail-delivery">- 배송기간</p>
                            <p className="detail-delivery">평일기준 오후 3시까지 결제완료 건에 한해 당일 출고됩니다.</p>
                            <p className="detail-delivery">당일 오후 3시 이후 주문건은 평일 기준 익일 출고 됩니다.</p>
                            <p className="detail-delivery">
                    ...
                    <AccordionItem>
                        ...
                        <AccordionItemPanel>
                            <p className="detail-change-bold">교환 및 반품이 가능한 경우:</p>
                            ...
                            <p className="detail-change-bold">교환 및 반품이 불가능한 경우:</p>
                            <p className="detail-change">
                            ...
                            <p className="detail-change">- 복제가 가능한 상품 등의 포장을 훼손한 경우</p>
                            <p className="detail-change">
                            ...
                            <div className="detail-change-div">
                                <p className="detail-change">
                                    - 교환/반품/환불에 대한 자세한 문의는 고객센터(☎1544-2083)를 이용하시거나 Q&A
                                    게시판을 이용하시기 바랍니다.
                                </p>
                                <p className="detail-change">
                                    - 고객센터 운영 시간 : 09:00 ~ 18:00 (주말, 공휴일 휴무 / 12:00~13:30 점심시간)
                                </p>
                                <p className="detail-change">
                                ...
                                <p className="detail-change">
                                    - 단, 소비자분쟁해결기준에 구체적인 정함이 없는 경우에는 관계법령 또는 상관례,
                                    회사의 개별약관(공지)에 따릅니다.
                                </p>
                            </div>
                        </AccordionItemPanel>
